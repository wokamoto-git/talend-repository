...
package nssol.adddatasetfromtdc_03_0_1;
...
/**
 * Job: AddDatasetFromTDC_03 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class AddDatasetFromTDC_03 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "AddDatasetFromTDC_03.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(AddDatasetFromTDC_03.class);
	...
	private final String jobName = "AddDatasetFromTDC_03";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_JsJWsJhTEeubEu0sfA4SPQ", "0.1");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					AddDatasetFromTDC_03.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(AddDatasetFromTDC_03.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_NSSOL_AddDatasetFromTDC_03 = new byte[0];
		static byte[] commonByteArray_NSSOL_AddDatasetFromTDC_03 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NSSOL_AddDatasetFromTDC_03.length) {
					if (length < 1024 && commonByteArray_NSSOL_AddDatasetFromTDC_03.length == 0) {
						commonByteArray_NSSOL_AddDatasetFromTDC_03 = new byte[1024];
					} else {
						commonByteArray_NSSOL_AddDatasetFromTDC_03 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NSSOL_AddDatasetFromTDC_03, 0, length);
				strReturn = new String(commonByteArray_NSSOL_AddDatasetFromTDC_03, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NSSOL_AddDatasetFromTDC_03) {
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tSetGlobalVar_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tSetGlobalVar_1.append("VARIABLES" + " = " + "[{VALUE=" + ("row3.projectId")
									+ ", KEY=" + ("\"groupId\"") + "}]");
				...
				try {
					...
					if (use_auth_tRESTClient_1 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:BoOcgOT3SKdkdThGuo4d2K+6VV0Jb3eDIt8NSNkQ52X77arCGw==");
					...
					if (use_auth_tRESTClient_1 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:yyE0N0bcD1k4Da54BIyieLnqVRayI2qxFrs8R9Xnm51h4dlhmg==");
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:cpFHdxBL+WylgcP+TiMiXBAXY941xfX1XO25xOcgaQTsPrqacw==");
					...
					if (use_auth_tRESTClient_1 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_1 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:EQFy02ARCik2BNXzGQNrxY76DWWz3FGzf8HZDebPb4XWFQMhSQ==");
...
///////////////////////    			
									...
									globalMap.put("groupId", row3.projectId);
				...
				try {
					...
					if (use_auth_tRESTClient_3 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:vyeFUunma8r5DNSyDoUToIvYLRBssaD/PygjOqkI8B0R0WNG");
					...
					if (use_auth_tRESTClient_3 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:2+n+uaC3CNwlQ8IlhUlxAna5goTznZrJj0dUcfz2poXFIy5N");
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:VtMpI7ezd0XMv7VV4+tlacfcgBEOR2PYneAebTfrDMOI4oGN");
					...
					if (use_auth_tRESTClient_3 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_3 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:RnHcBCZaq8HPDWa9N3UbXZr/CvKfGjnzWq28J8SvEaIksvXK");
					...
					webClient_tRESTClient_3.query("name", "customer");
...
// expected response body
				...
				try {
					...
					String url = "https://api.ap.cloud.talend.com/tmc/v2.3/projects/60abca00-3f37-4639-927f-3456ffd305ca/groups";
					// {baseUri}tRESTClient
					...
					if (use_auth_tRESTClient_2 && "SAML".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:MZgBJMM1GjDRmN4IlJRYFV5B4lEj5J0EPGaGRkINNzw0yTJl/w==");
					...
					if (use_auth_tRESTClient_2 && "BASIC".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:0YEXWzoUvh+o3LLWRyJG3W1U4t8oVpyXzNGyQu5u5laqM1igng==");
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:YvnH0WkSguYleID2VwzqptHiutoNWDdmDTBs+cRZkyarcim9lw==");
					...
					if (use_auth_tRESTClient_2 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
						...
						final String decryptedPassword_tRESTClient_2 = routines.system.PasswordEncryptUtil
								.decryptPassword(
										"enc:routine.encryption.key.v1:7/6YSeojM6WCpQDlQDo89bL45km/pvCI7gamHQMbkJIM+1w2Hw==");
									...
									try {
										...
										if (use_auth_tRESTClient_4 && "SAML".equals("OAUTH2_BEARER")) {
											...
											final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
													.decryptPassword(
															"enc:routine.encryption.key.v1:JTSXdoYDJ95VaOjFJRH88TrkTM3vkwACtUstrUFN4vGMBEIZ");
										...
										if (use_auth_tRESTClient_4 && "BASIC".equals("OAUTH2_BEARER")) {
											...
											final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
													.decryptPassword(
															"enc:routine.encryption.key.v1:gNHlTY2yehxLvTo8UYcZunSgqjuu1y8DI29Cj/lUTcj+N3x/");
											...
											final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
													.decryptPassword(
															"enc:routine.encryption.key.v1:7rSNW+khhFZwlRHfUMCSqgafI4+ymt8UJWzjm3GLWIhMHyKp");
										...
										if (use_auth_tRESTClient_4 && "OIDC_PASSWORD_GRANT".equals("OAUTH2_BEARER")) {
											...
											final String decryptedPassword_tRESTClient_4 = routines.system.PasswordEncryptUtil
													.decryptPassword(
															"enc:routine.encryption.key.v1:ZjlxdhBOTfXhQHt83e0Olu/FAItxwSIP6XDzFapNcq6AGgMx");
...
// [tRESTCliend_end]
	...
	public static void main(String[] args) {
		final AddDatasetFromTDC_03 AddDatasetFromTDC_03Class = new AddDatasetFromTDC_03();

		int exitCode = AddDatasetFromTDC_03Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'AddDatasetFromTDC_03' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'AddDatasetFromTDC_03' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = AddDatasetFromTDC_03.class.getClassLoader()
					.getResourceAsStream("nssol/adddatasetfromtdc_03_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = AddDatasetFromTDC_03.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : AddDatasetFromTDC_03");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 203029 characters generated by Talend Cloud Data Management Platform on the
 * 2021/04/08 20:54:01 JST
 ************************************************************************************************/