...
package wokamoto_project.loglevel_trace01_0_1;
...
/**
 * Job: LogLevel_Trace01 Purpose: <br>
 * Description:  <br>
 * @author Okamoto, Wataru
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class LogLevel_Trace01 implements TalendJob {
	static {System.setProperty("TalendJob.log", "LogLevel_Trace01.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(LogLevel_Trace01.class);
...
public String getFilepath(){
	...
	private final String jobName = "LogLevel_Trace01";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_kbWWMLIbEeuWb7XiaevDLw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LogLevel_Trace01.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LogLevel_Trace01.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_WOKAMOTO_PROJECT_LogLevel_Trace01 = new byte[0];
    static byte[] commonByteArray_WOKAMOTO_PROJECT_LogLevel_Trace01 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WOKAMOTO_PROJECT_LogLevel_Trace01.length) {
				if(length < 1024 && commonByteArray_WOKAMOTO_PROJECT_LogLevel_Trace01.length == 0) {
   					commonByteArray_WOKAMOTO_PROJECT_LogLevel_Trace01 = new byte[1024];
				} else {
   					commonByteArray_WOKAMOTO_PROJECT_LogLevel_Trace01 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WOKAMOTO_PROJECT_LogLevel_Trace01, 0, length);
			strReturn = new String(commonByteArray_WOKAMOTO_PROJECT_LogLevel_Trace01, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WOKAMOTO_PROJECT_LogLevel_Trace01) {
 ...
 */
    ...
    public static void main(String[] args){
        final LogLevel_Trace01 LogLevel_Trace01Class = new LogLevel_Trace01();

        int exitCode = LogLevel_Trace01Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'LogLevel_Trace01' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("monitoring"));
        	...
        	log.info("TalendJob: 'LogLevel_Trace01' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = LogLevel_Trace01.class.getClassLoader().getResourceAsStream("wokamoto_project/loglevel_trace01_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LogLevel_Trace01.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LogLevel_Trace01");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     75040 characters generated by Talend Cloud Real-Time Big Data Platform 
 *     on the 2021/05/11 14:50:21 JST
 ************************************************************************************************/